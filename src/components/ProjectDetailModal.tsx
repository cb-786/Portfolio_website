        ...
        >
          ...
          <ScrollArea className="flex-1 px-4 sm:px-6">
            ...
            <Tabs defaultValue="overview" className="mb-6">
              <div className="sticky top-0 z-50 pb-4 bg-background/95">
      ...
      >
        ...
        <ScrollArea className="flex-1">
          <div className="relative">
            ...
            {/* Tech Badges - Sticky */}
            <div className="sticky top-0 z-40 px-8 py-4 border-b border-border bg-background/95">
              <div className="flex flex-wrap gap-2">
                {project.tags.map((tag) => (
            ...
            <Tabs defaultValue="overview" className="px-8">
              ...
              <div className="sticky top-[72px] z-50 pt-4 pb-2 flex justify-center">
                <div className="bg-background/95 rounded-full p-1">
