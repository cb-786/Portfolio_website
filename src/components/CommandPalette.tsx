  ...
  const projectsData = [
    {
      ...
      description: "React, Node.js, Express.js, MongoDB platform with real-time watchlists",
      category: "project" as const,
      icon: <Briefcase className="mr-2 h-4 w-4" />,
      action: () => window.open("https://github.com/cb-786/full_stack_major_project-Stock-trading-platform", "_blank")
    },
    {
      id: "eeg-signals",
      title: "EEG Signal Classification Pipeline",
      description: "Machine learning pipeline for ADHD detection achieving 95.83% accuracy",
      category: "project" as const,
      icon: <Briefcase className="mr-2 h-4 w-4" />,
      action: () => window.open("https://github.com/cb-786/ADHD_Detection_using_EEG_signals", "_blank")
    },
  ];
    ...
    <>
      ...
      <CommandList className={isMobile ? "max-h-none flex-1 overflow-y-auto" : undefined}>
        ...
        <CommandGroup heading="Actions">
          <CommandItem onSelect={() => {
            window.open('https://drive.google.com/file/d/1hEO5lhU6Fop6uguqTnnXk4bPXfOkTgpe/view', '_blank');
            setOpen(false);
          }}>
          ...
          <CommandItem onSelect={() => {
            window.open("https://github.com/cb-786", "_blank");
            setOpen(false);
          }}>
          ...
          <CommandItem onSelect={() => {
            window.open("https://www.linkedin.com/in/aspiring-chirag-bansal-/", "_blank");
            setOpen(false);
          }}>
