      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-white">Chirag Bansal</h3>
            <p className="text-gray-400">
              Bachelor of Engineering in Computer Engineering student at Thapar Institute, specializing in Full-Stack Development and Machine Learning research.
            </p>
            <div className="flex gap-3">
              <a
                href="https://www.linkedin.com/in/aspiring-chirag-bansal-/"
                target="_blank"
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © 2025 Chirag Bansal. All rights reserved.
            </p>
